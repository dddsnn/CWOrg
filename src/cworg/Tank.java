...
public class Tank implements Serializable {
	private static class TankInfo {
		...
		private TankInfo() {
			...
			name_map.put(TankType.PATTON, "Patton");
			...
			short_name_map.put(TankType.T110E5, "110");
			short_name_map.put(TankType.M103, "103");
			short_name_map.put(TankType.PATTON, "M46");
			...
			tier_map.put(TankType.PATTON, 9);
			...
			tier_map.put(TankType.BATCHAT, 9);
			...
			nation_map.put(TankType.PATTON, TankNation.USA);
			...
			class_map.put(TankType.PATTON, TankClass.MEDIUM);
